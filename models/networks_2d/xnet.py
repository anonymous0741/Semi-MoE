...
class XNet_sb(nn.Module):
    ...
    def forward(self, input1):
        ...
        # return {
        #     "low_level_features": x1_1,
        #     "mid_level_features": x1_2,
        #     "bottleneck_features": x1_5_1,
        #     "prediction": prediction
        # }
        # return prediction, x1_1
        # return prediction, x1_2
        return prediction, torch.cat([x1_1.view(x1_1.size(0), -1), 
                    x1_5_1.view(x1_5_1.size(0), -1)], dim=1)
